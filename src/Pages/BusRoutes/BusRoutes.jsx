...
const BusRoutes = (props) => {
    ...
    const handleFinalSubmit = (event) => {
        ...
        console.log("Hello")
        Navigate('/filldetails', { state: { ChoosedBus: { selectedBus }, ChoosedSeat: { selectedSeats } } })
    }
            ...
            <div className="contain">
                {filteredData.length > 0 ? <div className="col-md-12 bus-div">
                                ...
                                <div className="row m-0"  >
                                    <div className="col-md-9" style={{ borderRight: "1px solid #ccc", height: "100%" }} >
                                        <div>
                                            ...
                                            <h6
                                                ...
                                                style={{ fontSize: "15px" }}
                                            >
                                                {`${bus.startTime}, ${moment.unix(bus.date/1000).format("YYYY/MM/DD")}`}
                                                <span className="text px-3" style={{ marginLeft: "10px", color: "gray", fontSize: "13px" }}>
                                                    <p></p>
                                                </span>

                                                {`${bus.EndTime}, ${moment.unix(bus.date/1000).format("YYYY/MM/DD")}`}
                                            </h6>
                                    ...
                                    <div className="col-md-3 d-flex justify-content-center">
                                        <div className="d-flex justify-content-center" style={{ alignItems: "center", flexDirection: "column" }}>
                                            ...
                                            <button className="btn mt-3 mb-3" style={{ color: "white", backgroundColor: "#f54278 " }} onClick={() => handleBookNowClick(bus)}>
                    ...
                    <div className='d-flex justify-content-center' style={{ flexDirection: 'column', alignItems: 'center' }}>
                        <img src="https://clipart-library.com/img/795647.jpg" alt="NoBus" style={{ height: '300px', width: '300px', marginTop: '-50px' }} />
                        <p className='' style={{
                            fontWeight: "bold",
                            fontFamily: "cursive",
                            fontSize: "30px",
